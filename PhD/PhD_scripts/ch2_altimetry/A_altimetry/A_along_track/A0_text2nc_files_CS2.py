...
#filenames = ['202101_MERGE']  # test file

workdir = '/Users/iw2g24/PycharmProjects/CS2_extension/PhD/PhD_data/altimetry_cpom/'
...
m = Basemap(projection='spstere', 
            ...
            resolution='f', 
            round=True,
            ellps='WGS84') #ellipsoid could be geoid to make it relative to only the dynamic changes to oceanic processes
